...
data type file_xfer from FileXfer.idl.
This example builds two applications, named FileXfer_publisher and
FileXfer_subscriber.
...
> make -f makefile_FileXfer_x64Darwin17clang9.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_FileXfer_x64Darwin17clang9.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the FileXfer_publisher.cxx
file where it says:
...
> objs/x64Darwin17clang9.0/FileXfer_publisher <domain_id> <sample_count>
> objs/x64Darwin17clang9.0/FileXfer_subscriber <domain_id> <sample_count>
